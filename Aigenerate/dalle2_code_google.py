...
credentials = service_account.Credentials.from_service_account_file(r'C:\Users\amanj\OneDrive\Desktop\Detecting-AI-Generated-Fake-Images-main\Detecting-AI-Generated-Fake-Images-main\AI_generate\archij-99c117678fdc.json', scopes=['https://www.googleapis.com/auth/drive'])
...
def save_original_photo_to_drive(input_image_path, folder_id, photo_title):
    ...
    photo_title_str = str(photo_title)
    file_metadata = {
        'name': photo_title_str + '.png',
        'mimeType': 'image/png',
        'parents': [folder_id]
    }
...
def generate_image(input_image_path, n, photo_title):
    ...
    human_folder_id = "1W0ajWbrlJrMmcQuwAdAAj2KDDSbzwo1N?usp=drive_link"
